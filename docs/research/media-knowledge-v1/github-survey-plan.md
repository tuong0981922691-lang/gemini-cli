...
4. Chuẩn hóa URL ứng viên trước khi tạo Knowledge ID. Yêu cầu lặp lại cùng URL
   phải nối thêm lần kiểm tra vào evidence history của record hiện có, không tạo
   record trùng hoặc nâng mức tin cậy khi chưa có bằng chứng mới.
