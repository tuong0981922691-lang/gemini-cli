...
| Vùng cách ly         | `glifxyz/glif-mcp-server`; mọi khẳng định chưa đối chiếu trong báo cáo | URL/owner do người dùng cung cấp; truy cập mạng thất bại | Cấp snapshot hoặc mở truy cập chỉ đọc, sau đó băm và kiểm tra tĩnh |
